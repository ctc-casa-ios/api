...
class User < ApplicationRecord
  ...
  devise :database_authenticatable, :jwt_authenticatable, :invitable, :recoverable, :validatable, :timeoutable, :trackable, :registerable, jwt_revocation_strategy: JwtDenylist
